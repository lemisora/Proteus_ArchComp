...
HD_PWD='C:/Users/DELL/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_74LS181.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_74LS181.tcl
