...
HD_PWD='C:/Users/DELL/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_74LS181.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_74LS181.tcl -notrace
