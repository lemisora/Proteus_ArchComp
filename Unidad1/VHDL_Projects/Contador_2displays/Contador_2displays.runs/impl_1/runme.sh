...
HD_PWD='C:/Users/DELL/Documents/GitHub/Proteus_ArchComp/Unidad1/VHDL_Projects/Contador_2displays/Contador_2displays.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_2displays.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contador_2displays.tcl -notrace
