...
HD_PWD='C:/Users/DELL/Documents/GitHub/Proteus_ArchComp/Unidad1/VHDL_Projects/Contador_7seg/Contador_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contador_7seg.tcl -notrace
