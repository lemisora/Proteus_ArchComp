...
HD_PWD='C:/Users/DELL/Documents/GitHub/Proteus_ArchComp/Unidad1/VHDL_Projects/Contador_7seg/Contador_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contador_7seg.tcl
