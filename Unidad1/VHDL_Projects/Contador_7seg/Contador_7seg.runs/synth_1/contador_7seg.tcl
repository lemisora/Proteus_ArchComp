...
synth_design -top contador_7seg -part xc7a35tcpg236-3
...
write_checkpoint -force -noxdef contador_7seg.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file contador_7seg_utilization_synth.rpt -pb contador_7seg_utilization_synth.pb"  } 
