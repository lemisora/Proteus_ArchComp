...
HD_PWD='/home/lemisora/Vivado/Semaforo/Semaforo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SemaforoLog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SemaforoLog.tcl -notrace
