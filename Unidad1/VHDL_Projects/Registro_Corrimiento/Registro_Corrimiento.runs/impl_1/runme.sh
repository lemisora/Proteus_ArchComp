...
HD_PWD='C:/Users/DELL/Registro_Corrimiento/Registro_Corrimiento.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegisters.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ShiftRegisters.tcl -notrace
