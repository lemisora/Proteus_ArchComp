...
HD_PWD='C:/Users/DELL/Registro_Corrimiento/Registro_Corrimiento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegisters.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShiftRegisters.tcl
