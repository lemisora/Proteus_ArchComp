...
HD_PWD='/home/lemisora/Vivado/Semaforo/Semaforo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SemaforoLog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SemaforoLog.tcl
